...
const NODES: Record<string, { x: number; y: number; label: string; role: string; emoji: string }> = {
  ...
  specialist:   { x: 650, y: 90,  label: "Specialist",   role: "domain agent", emoji: "🎓" },
  pool:         { x: 850, y: 280, label: "Experience Pool", role: "storage",  emoji: "📚" },
  contributor:  { x: 650, y: 470, label: "Contributors", role: "anonymous",   emoji: "✍️" },
  con:          { x: 450, y: 470, label: "Con",          role: "represents",   emoji: "🤝" },
